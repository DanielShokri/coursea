...
export default function Reviews({ reviews }: { reviews: any[] }) {
  ...
  const getReviewDate = (timestamp: string) => {
    const date = new Date(+timestamp);

    // Convert the date to a local date string
  ...
  return (
    <>
              ...
              {reviews.map((review, reviewIdx) => (
                ...
                >
                  ...
                  >
                    ...
                    <p>
                      <time dateTime={getReviewDate(review.createdAt)}>
      ...
      <AddReview isAddReview={isAddReview} setIsAddReview={setIsAddReview} />
    </>
  );
}
